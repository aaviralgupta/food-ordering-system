...
public class OrderApprovalEventKafkaPublisher implements RestaurantApprovalRequestMessagePublisher {
    ...
    public void publish(OrderApprovalOutboxMessage orderApprovalOutboxMessage,
        ...
        OrderApprovalEventPayload orderApprovalEventPayload =
                kafkaMessageHelper.getOutboxMessageEventPayload(orderApprovalOutboxMessage.getPayload(),
        ...
        try {
            ...
            log.error("Error while sending OrderApprovalEventPayload to Kafka for orderID: {} and sagaId: {}, error :{}",
