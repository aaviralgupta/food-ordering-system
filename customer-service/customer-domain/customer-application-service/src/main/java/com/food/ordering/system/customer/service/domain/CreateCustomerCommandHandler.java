...
public class CreateCustomerCommandHandler {
    ...
    public CreateCustomerCommandHandler(CustomerDomainService customerDomainService,
    ...
    public CustomerCreatedEvent createCustomer(CreateCustomerCommand createCustomerCommand) {
        ...
        log.info("Returning customer created event for customer id: {}", createCustomerCommand.getCustomerId());
