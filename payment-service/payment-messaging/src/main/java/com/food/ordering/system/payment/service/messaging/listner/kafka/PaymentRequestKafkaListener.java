        ...
        messages.forEach(paymentRequestAvroModel -> {
            try {
                if(PaymentOrderStatus.PENDING == paymentRequestAvroModel.getPaymentOrderStatus()){
                    log.info("Processing payment for orderId: {}",paymentRequestAvroModel.getOrderId());
                    ...
                    log.info("Cancelling payment for orderId: {}",paymentRequestAvroModel.getOrderId());
                ...
                if(sqlException != null && sqlException.getSQLState() !=null &&
                    ...
                    log.error("Caught unique constraint exception with sql state : {} "+
                            "in PaymentRequestKafkaListener for order id : {}", sqlException.getSQLState(),
